...
st.markdown(
    f"""
    <style>
    /* Scope styles only to the game card grid */
    #cardgrid .stButton > button {{
        /* Keep the card square and big */
        aspect-ratio: 1 / 1 !important;
        width: 100% !important;
        min-height: {HEIGHT_PX}px !important;
        height: auto !important;
        /* Big, centered content */
        ...
        /* Base font (fallback if emoji selector misses) */
        font-size: {FONT_PX}px !important;
        line-height: 1 !important;
    }}

    /* Enlarge whatever element Streamlit uses for the label (p/span/div) */
    #cardgrid .stButton > button *,
