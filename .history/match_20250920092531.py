...
size_choice = st.sidebar.select_slider(
    "Card size", options=["Normal", "Large", "XL", "Huge"], value="XL"
)
...
if size_choice == "Normal":
    ...
    FONT_PX, PAD_PX, HEIGHT_PX, GAP_PX = 88, 22, 150, 14
elif size_choice == "XL":
    FONT_PX, PAD_PX, HEIGHT_PX, GAP_PX = 110, 26, 180, 16
else:  # Huge
    FONT_PX, PAD_PX, HEIGHT_PX, GAP_PX = 140, 30, 220, 20
